...
@Slf4j
public class ModuleBatchUpdateLogSaver extends BatchUpdateLogSaver {

    public ModuleBatchUpdateLogSaver(LogBroadCaster broadcaster, ConversationRepository conversations) {
        super(broadcaster, conversations);
        log.info("ModuleBatchUpdateLogSaver is enabled");
    }
