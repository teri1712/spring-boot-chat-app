...
public class Setting extends AbstractAggregateRoot<Setting> {
    ...
    public void setPreference(UUID maker, Preference preference) {
        this.preference = preference;
        ...
        registerEvent(PreferenceChanged.builder()
            ...
            .themeBackground(Optional.ofNullable(preference.theme()).map(Theme::getBackground).orElse(null))
            .themeName(Optional.ofNullable(preference.theme()).map(Theme::getName).orElse(null))
            .makerId(maker)
    ...
    public static class PreferenceChain {
        ...
        public Preference complete() {
            return new Preference(iconId, customName, customAvatar, theme);
        }
