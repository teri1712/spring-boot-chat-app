...
@Service
public class IconParticipantEventPlacedListener extends AbstractParticipantEventPlacedListener<IconParticipantPlaced> {
    public IconParticipantEventPlacedListener(ChatRepository chats, ParticipantRepository participants, ApplicationEventPublisher applicationEventPublisher, EngagementPolicy engagementPolicy, EventPlacedMapper mapper) {
