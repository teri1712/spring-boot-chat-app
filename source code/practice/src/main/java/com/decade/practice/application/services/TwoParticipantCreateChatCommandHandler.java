...
import com.decade.practice.application.domain.TwoParticipantChatIdentifierMaker;
...
@AllArgsConstructor
@Transactional
public class TwoParticipantCreateChatCommandHandler implements CreateChatCommandHandler {

    private final TwoParticipantChatIdentifierMaker identifierMaker;
    ...
    public ChatDetails create(UUID requesterId, UUID partnerId) {
        ...
        String roomName = "Room between " + user.getName() + " and " + partner.getName();
        try {
