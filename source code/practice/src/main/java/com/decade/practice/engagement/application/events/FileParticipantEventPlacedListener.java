...
@Service
public class FileParticipantEventPlacedListener extends AbstractParticipantEventPlacedListener<FileParticipantPlaced> {
    public FileParticipantEventPlacedListener(ChatRepository chats, ParticipantRepository participants, ApplicationEventPublisher applicationEventPublisher, EngagementPolicy engagementPolicy, EventPlacedMapper mapper) {
