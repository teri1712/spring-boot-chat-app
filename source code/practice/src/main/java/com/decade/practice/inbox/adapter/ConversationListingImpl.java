...
public class ConversationListingImpl implements ConversationListing {
      ...
      @Override
      public List<Conversation> findByModifiedAtLessThan(HashValue anchorHash, UUID ownerId, Pageable pageable) throws Throwable {
            Conversation anchor = conversations.findFirstByHash(anchorHash).orElseThrow(new Supplier<Throwable>() {
                  @Override
                  public Throwable get() {
                        return new MismatchHashException();
                  }
            });
      ...
      @Override
      public List<Conversation> findByModifiedAtLessThan(UUID ownerId, Instant modifiedAt, Pageable pageable) {
