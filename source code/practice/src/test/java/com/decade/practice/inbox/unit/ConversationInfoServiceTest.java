...
class ConversationInfoServiceTest {
    ...
    void givenRoomHas2RepresentativesIncludingMe_whenGettingThatRoomInfo_thenConversationNameIsTheOtherName() {
        Partner me = new Partner(UUID.randomUUID(), "teri", "teri.jpg");
        Partner other = new Partner(UUID.randomUUID(), "other", "other.jpg");
        ...
        assertThat(info.getName(lookUp)).isEqualTo("other");
        assertThat(info.getAvatar(lookUp)).isEqualTo("other.jpg");
    }

    @Test
    void givenRoomHas2RepresentativesNotIncludingMe_whenGettingThatRoomInfo_thenConversationNameIsTheOtherNames() {
        Partner me = new Partner(UUID.nameUUIDFromBytes("teri".getBytes()), "teri", "teri.jpg");
        Partner other1 = new Partner(UUID.nameUUIDFromBytes("other1".getBytes()), "other1", "other1.jpg");
        Partner other2 = new Partner(UUID.nameUUIDFromBytes("other2".getBytes()), "other2", "other2.jpg");
        ...
        assertThat(Set.of("other2, other1", "other1, other2")).contains(info.getName(lookUp));
    }
}
