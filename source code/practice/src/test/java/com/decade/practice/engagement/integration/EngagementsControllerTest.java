...
import com.decade.practice.engagement.api.events.*;
...
class EngagementsControllerTest extends BaseTestClass {
    ...
    void givenValidTextEvent_whenAliceSendsToBob_thenStatusCreated() throws Exception {
        ...
        mockMvc.perform(post("/chats/{chatIdentifier}/text-events", chatIdentifier)
                ...
                .andExpect(jsonPath("$.idempotentKey").value(idempotentKey));


        assertThat(events.stream(TextParticipantPlaced.class)).hasSize(1);
    ...
    void givenExistingChat_whenAliceUpdatesPreference_thenPreferenceIsStored() throws Exception {
        ...
        assertThat(events.stream(PreferenceParticipantPlaced.class)).hasSize(1);
        assertThat(events.stream(PreferenceEventPlaced.class)).hasSize(2);
    ...
    void givenValidImageEvent_whenAliceSendsToBob_thenStatusCreated() throws Exception {
        ...
        assertThat(events.stream(ImageParticipantPlaced.class)).hasSize(1);
        assertThat(events.stream(ImageEventPlaced.class)).hasSize(2);
    }
    ...
    void givenValidIconEvent_whenAliceSendsToBob_thenStatusCreated() throws Exception {
        ...
        assertThat(events.stream(IconParticipantPlaced.class)).hasSize(1);
        assertThat(events.stream(IconEventPlaced.class)).hasSize(2);
    }
    ...
    void givenValidSeenEvent_whenAliceSendsToBob_thenStatusCreated() throws Exception {
        ...
        assertThat(events.stream(SeenParticipantPlaced.class)).hasSize(1);
        assertThat(events.stream(SeenEventPlaced.class)).hasSize(2);
    }
    ...
    void givenValidFileEvent_whenAliceSendsToBob_thenStatusCreated() throws Exception {
        ...
        assertThat(events.stream(FileParticipantPlaced.class)).hasSize(1);
        assertThat(events.stream(FileEventPlaced.class)).hasSize(2);
    }
