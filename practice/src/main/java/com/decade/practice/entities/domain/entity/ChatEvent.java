...
import com.decade.practice.entities.local.Chat;
...
public abstract class ChatEvent {
      ...
      private com.decade.practice.entities.domain.entity.Chat chat;
      ...
      protected ChatEvent(com.decade.practice.entities.domain.entity.Chat chat, User sender, String eventType) {
            this.chat = chat;
            this.sender = sender;
      ...
      public com.decade.practice.entities.domain.entity.Chat getChat() {
            return chat;
      }

      public void setChat(com.decade.practice.entities.domain.entity.Chat chat) {
            this.chat = chat;
            this.chatIdentifier = chat.getIdentifier();
      }
